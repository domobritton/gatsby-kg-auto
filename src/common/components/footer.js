      ...
      <Footer>
        <div className="flex flex-wrap justify-around w-100 mw9 center mb5">
          <div className="w-100 mw5 mb4">
            <span className="f2">{data.site.siteMetadata.siteTitle}</span>
            <hr />
          ...
          <div className="flex flex-column">
            <span className="near-white f5 tracked mb3 db">MORE ON {data.site.siteMetadata.siteTitle}</span>
            <Link to="/visit" className="near-white f5 tracked pv1 db">VISIT US</Link>
            <Link to="/reviews" className="near-white f5 tracked pv1 db">REVIEWS</Link>
        ...
        <div className="w-100 mw9 center silver mb3">
          ...
          <div className="flex w-100 mw6 items-center justify-center justify-start-ns">
            <a href="/sitemap.xml" className="silver f5 tracked pv1 db mh1">SITEMAP</a>
            <span className="mh1">|</span>
            <Link to="/privacy" className="silver f5 tracked pv1 db mh1">PRIVACY</Link>
          </div>
        </div>
        <div className="w-100 mw9 silver center f6">
